...
const Footer = () => {
    return (
        <footer className="bg-custom-primary mt-20 py-10">
            <div className="container">
                <div className="footer footer-center text-white gap-14 rounded">
                    ...
                    <aside className="footerCopyRights">
                        <p>All right reserved ©Discount PRO -{new Date().getFullYear()}.<br className="lg:hidden" /> Developed by <a href="https://atiqur.pages.dev/"><b>Atiqur Rahman</b></a></p>
                    </aside>
                </div>
            </div>
        </footer>
