                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-4 gap-y-12">
                    {
                        onSaleBrands?.map((brand,index)=>(
                            <Link to={`/brand/${brand._id}`} key={index} className="card border-2 border-custom-half-primary rounded-lg duration-500 hover:shadow-md">
                                <figure className="">
                                    <img
                                ...
                                <div className="card-body pt-0">
                                    ...
                                    <button className="text-custom-primary text-xs bg-custom-half-primary px-2 p-1 rounded-full w-fit">{brand.coupons.length} Coupons</button>
                                </div>
                            </Link>
                        ))
                    }
