...
const BrandsPageSidebar = () => {
    ...
    return (
        <div className='flex flex-wrap justify-between items-baseline gap-x-8 gap-y-4'>
            ...
            <div className="space-y-4 md:w-full relative">
                <p onClick={()=>setShowFilter(!showFilter)} className='text-custom-primary font-bold uppercase'>Filter By Category</p>
                <div className={`join join-vertical w-full absolute z-20 md:static ${showFilter?null:"hidden md:flex"}`} >
                    {
